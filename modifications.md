...
| **Edge Policy** | Hubs & Discover Features | Policy Key | Set `HubsSidebarEnabled / DiscoverPage = 0` |
...
| **Edge Update** | Update Logic (Google/Native) | System Service | Disabled `edgeupdate` and `edgeupdatem` |
